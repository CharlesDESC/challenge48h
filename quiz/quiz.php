...
<body>
    <div class="container">
        ...
        <div id="rules">
            ...
            <p>Ce mini-jeu consiste en un simple quiz de culture générale. Sport, cinéma, politique, histoire et autres
                domaines seront à l'honneur dans une suite aléatoire de devinettes.</p>
            <p>I. Une série de trois questions vous sera présentée, dans l'ordre croissant de difficulté. <br>
                ...
                III. Afin de remporter un missile, vous devrez répondre correctement aux <strong>trois</strong>
                questions. <br>
                ...
                Attention : vous ne pourrez pas revenir en arrière. </p>
        </div>
