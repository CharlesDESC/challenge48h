...
<body>
    ...
    <main class="main">
        <?php if ($data["missile"] < 1) {
            echo '<div id="bataillenavale" class="grilleTableau dissableelement">';
        } else {
            echo '<div id="bataillenavale" class="grilleTableau">';
        } ?>
        <table id="plateau">
            <thead>
                <tr>
        ...
        <div class="containerCarousel">
            ...
            <div class="carousel">
                <div class="slides">
                    ...
                    <a href="./quiz/quiz.php"><img src="./img/cultureG.png" alt="cultureG"></a>
