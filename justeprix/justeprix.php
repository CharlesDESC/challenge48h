...
<body>
    ...
    <div class="page">
        ...
        <hr>
        <p>Entrez un nombre entre 0 et 1000</p><i class="fa-solid fa-triangle-exclamation"></i>
        <br /><br />
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Le but est simple ! Pour gagner un point, le joueur doit trouver le bon nombre en 10 essais ou moins. </p>
